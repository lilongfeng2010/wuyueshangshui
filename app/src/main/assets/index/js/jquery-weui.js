  ...
  var Calendar = function (params) {
      ...
      p.updateCurrentMonthYear = function (dir) {
          if (typeof dir === 'undefined') {
              ...
              p.currentMonth = parseInt(p.months.eq(dir === 'next' ? (p.months.length - 0) : 0).attr('data-month'), 10);
              p.currentYear = parseInt(p.months.eq(dir === 'next' ? (p.months.length - 0) : 0).attr('data-year'), 10);
          }
